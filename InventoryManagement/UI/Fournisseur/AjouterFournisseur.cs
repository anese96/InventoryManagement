...
namespace InventoryManagement.UI.Fournisseur
{
    public partial class AjouterFournisseur : Form
    {
        ...
        public AjouterFournisseur( FunctionUI functionUI , IService<VendorDto> service)
        {
            InitializeComponent();
        ...
        private void InitializeCustomComponents()
        {
            ...
            txtReference.Text = "FR-" + DateTime.Now.ToString("HHmmss");
